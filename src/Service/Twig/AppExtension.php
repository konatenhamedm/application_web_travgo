...

{
    ...
    public function __construct(Breadcrumb $breadcrumb, RouterInterface $router, Environment $templating, TokenStorageInterface $token, EntityManagerInterface $em)
...

    {
        ...
        return [
           ...
           // new TwigTest('istanceof', [$this, 'isInstance'])
