$(document).ready(function() {
    //const $table_banque = $('#table-banque');
    var $addLink = $('.add_banque');
    var $container = $('#banque-list');
    ...
    if (index == 0) {
        ...
        if (index > 0) {
            ...
            $container.children('tr.prototype_banque').each(function() {
                const $this = $(this);
    ...
    function addLine($container) {
        ...
        var $prototype = $($("div#list-banque").attr('data-prototype').replace(/__name__label__/g, 'banque ' + (index + 1)).replace(/__name__/g, index));
